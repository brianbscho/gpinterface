...
import privateGpi from "./routes/private/gpis";
import publicGpi from "./routes/public/gpis";
...
fastify.register(privateGpi, { prefix: "/users/gpis" });
fastify.register(publicGpi, { prefix: "/gpis" });
