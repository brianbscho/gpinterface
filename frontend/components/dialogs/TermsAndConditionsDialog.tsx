...
export default function TermsAndConditions({
  ...
  useOpen: [open: boolean, setOpen: (o: boolean) => void];
}) {
      ...
      <DialogContent>
        ...
        <DialogDescription className="py-3">
          <div className="h-[70vh] overflow-y-auto">
            ...
            <div className="text-lg my-3">1. OUR SERVICES The</div>
            <div>
              ...
              are applicable. The Services are not tailored to comply with
            ...
            <div className="text-lg my-3">2. INTELLECTUAL PROPERTY RIGHTS</div>
            <div>
              ...
              Legal Terms, including the &quot;PROHIBITED ACTIVITIES&quot;
              section below, we grant you a non-exclusive, non-transferable,
              revocable license to: access the Services; and download or print a
              ...
              elsewhere in our Legal Terms, no part of the Services and no
              ...
              express prior written permission. If you wish to make any use of
              the Services, Content, or Marks other than as set out in this
              section or elsewhere in our Legal Terms, please address your
              request to: brian.b.cho@bookquilt.com. If we ever grant you the
              ...
              expressly granted to you in and to the Services, Content, and
              Marks. Any breach of these Intellectual Property Rights will
              constitute a material breach of our Legal Terms and your right to
              use our Services will terminate immediately. Your submissions and
              ...
              nor post any Contribution that is illegal, harassing, hateful,
              ...
              section, (b) any third partyâ€™s intellectual property rights, or
            ...
            <div className="text-lg my-3">3. USER REPRESENTATIONS</div>
            <div>
            ...
            <div className="text-lg my-3">4. USER REGISTRATION</div>
            <div>
            ...
            <div className="text-lg my-3">5. PURCHASES AND PAYMENT</div>
            <div>
              We accept the following forms of payment: - Visa - Mastercard -
              American Express - PayPal You agree to provide current, complete,
              ...
              your transactions and contact you as needed. Sales tax will be
              ...
              payment. We reserve the right to refuse any order placed through
            ...
            <div className="text-lg my-3">6. SUBSCRIPTIONS</div>
            <div>
              ...
              monthly. Free Trial We offer a 7-day free trial to new users who
              register with the Services. The account will not be charged and
              the subscription will be suspended until upgraded to a paid
              version at the end of the free trial. Cancellation All purchases
              are non-refundable. You can cancel your subscription at any time
              ...
              Services, please email us at brian.b.cho@bookquilt.com. Fee
              Changes We may, from time to time, make changes to the
              subscription fee and will communicate any price changes to you in
              accordance with applicable law.
            </div>
            <div className="text-lg my-3">7. PROHIBITED ACTIVITIES</div>
            <div>
              ...
              text), that interferes with any partyâ€™s uninterrupted use and
              ...
              burden on the Services or the networks or services connected to
              the Services. Harass, annoy, intimidate, or threaten any of our
              employees or agents engaged in providing any portion of the
              Services to you. Attempt to bypass any measures of the Services
              ...
              on the Services. Make any unauthorized use of the Services,
              ...
              pretenses. Use the Services as part of any effort to compete with
              us or otherwise use the Services and/or the Content for any
              revenue-generating endeavor or commercial enterprise. Generating
              illegal, harmful, or any content that violates regulations is
              strictly prohibited
            </div>
            <div className="text-lg my-3">8. USER GENERATED CONTRIBUTIONS</div>
            <div>
            ...
            <div className="text-lg my-3">9. CONTRIBUTION LICENSE</div>
            <div>
            ...
            <div className="text-lg my-3">10. GUIDELINES FOR REVIEWS</div>
            <div>
            ...
            <div className="text-lg my-3">11. SERVICES MANAGEMENT</div>
            <div>
            ...
            <div className="text-lg my-3">12. PRIVACY POLICY</div>
            <div>
              We care about data privacy and security. Please review our Privacy
              Policy:
              https://www.termsfeed.com/live/83ff1e0b-62b1-47f1-9b34-8d8630a71da0.
            ...
            <div className="text-lg my-3">13. COPYRIGHT INFRINGEMENTS</div>
            <div>
              We respect the intellectual property rights of others. If you
              believe that any material available on or through the Services
              infringes upon any copyright you own or control, please
            ...
            <div className="text-lg my-3">14. TERM AND TERMINATION</div>
            <div>
            ...
            <div className="text-lg my-3">16. GOVERNING LAW</div>
            <div>
              ...
              the State of Iowa, without regard to its conflict of law
              principles.
            </div>
            <div className="text-lg my-3">17. DISPUTE RESOLUTION</div>
            <div>
              ...
              (each a &quot;Dispute&quot; and collectively, the
              ...
              law, the arbitration will take place in Iowa. Except as otherwise
              ...
              the state and federal courts located in Iowa, and the Parties
              ...
              (UCITA) are excluded from these Legal Terms. In no event shall any
              Dispute brought by either Party related in any way to the Services
              ...
              jurisdiction of that court. Restrictions The Parties agree that
              ...
              or any other persons. Exceptions to Informal Negotiations and
            ...
            <div className="text-lg my-3">18. CORRECTIONS</div>
            <div>
            ...
            <div className="text-lg my-3">19. DISCLAIMER</div>
            <div>
            ...
            <div className="text-lg my-3">20. LIMITATIONS OF LIABILITY</div>
            <div>
            ...
            <div className="text-lg my-3">21. INDEMNIFICATION</div>
            <div>
              You agree to defend, indemnify, and hold us harmless, including
              our subsidiaries, affiliates, and all of our respective officers,
              agents, partners, and employees, from and against any loss,
              damage, liability, claim, or demand, including reasonable
              attorneysâ€™ fees and expenses, made by any third party due to or
            ...
            <div className="text-lg my-3">22. USER DATA</div>
            <div>
            ...
            <div className="text-lg my-3">25. MISCELLANEOUS</div>
            <div>
            ...
            <div className="text-lg my-3">26. CONTACT US</div>
            <div>
