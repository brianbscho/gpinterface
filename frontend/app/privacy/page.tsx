    ...
    <div className="w-full h-full overflow-y-auto">
      <div className="max-w-7xl mx-auto px-3">
        <div className="tab-content translations-content-item en" id="en">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to gpinterface.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to gpinterface, accessible from{" "}
                <a
                  href="https://gpinterface.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://gpinterface.com
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: brianbscho@gmail.com</li>
          </ul>
        </div>
      </div>
    </div>
