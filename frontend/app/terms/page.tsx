    ...
    <div className="w-full h-full overflow-y-auto">
      <div className="p-3 text-sm">
        ...
        <div>
          ...
          https://gpinterface.com (the &quot;Site&quot;), as well as any other
          related products and services that refer or link to these legal terms
          (the &quot;Legal Terms&quot;) (collectively, the
          &quot;Services&quot;). We offer an AI text generation service. You can
          contact us by email at brian.b.cho@bookquilt.com. These Legal Terms
          constitute a legally binding agreement made between you, whether
          personally or on behalf of an entity (&quot;you&quot;), and
          gpinterface, concerning your access to and use of the Services. You
        ...
        <div>
          ...
          brian.b.cho@bookquilt.com. If we ever grant you the permission to
          ...
          partyâ€™s intellectual property rights, or (c) applicable law. We may
        ...
        <div>
          ...
          American Express - PayPal You agree to provide current, complete, and
          ...
          shall be in US dollars. You agree to pay all charges at the prices
        ...
        <div>
          ...
          The length of your billing cycle is monthly. Free Trial We offer a
          7-day free trial to new users who register with the Services. The
          ...
          brian.b.cho@bookquilt.com. Fee Changes We may, from time to time, make
          changes to the subscription fee and will communicate any price changes
        ...
        <div>
          ...
          that interferes with any partyâ€™s uninterrupted use and enjoyment of
          ...
          &quot;pcms&quot;). Interfere with, disrupt, or create an undue burden
          ...
          or launch any unauthorized script or other software. Use a buying
          ...
          automated means or under false pretenses. Use the Services as part of
          any effort to compete with us or otherwise use the Services and/or the
          Content for any revenue-generating endeavor or commercial enterprise.
          Generating illegal, harmful, or any content that violates regulations
        ...
        <div className="text-lg my-3">15. MODIFICATIONS AND INTERRUPTIONS</div>
        <div>
        ...
        <div>
          ...
          construed in accordance with the laws of the State of Iowa applicable
          to agreements made and to be entirely performed within the State of
          Iowa, without regard to its conflict of law principles.
        </div>
        ...
        <div>
          ...
          where appropriate, the AAAâ€™s Supplementary Procedures for Consumer
          ...
          arbitration will take place in Iowa. Except as otherwise provided
          ...
          courts located in Iowa, and the Parties hereby consent to, and waive
          ...
          Terms. In no event shall any Dispute brought by either Party related
          ...
          that court. Restrictions The Parties agree that any arbitration shall
          ...
          of the general public or any other persons. Exceptions to Informal
        ...
        <div className="text-lg my-3">24. CALIFORNIA USERS AND RESIDENTS</div>
        <div>
        ...
        <div>
          ...
          at: gpinterface brian.b.cho@bookquilt.com
        </div>
      </div>
    </div>
  );
